...
<p align="center">
  <strong>当前统一版本 v0.4.0</strong>
  ·
  <a href="https://github.com/meyaomiao/wifi-health-console/releases/download/v0.4.0/Wi-Fi-Health-Console-0.4.0-universal.dmg">macOS 通用 DMG</a>
  ·
  <a href="https://github.com/meyaomiao/wifi-health-console/releases/download/v0.4.0/WiFi-Health-Console-Setup-x64.exe">Windows x64 EXE</a>
  ·
  <a href="https://github.com/meyaomiao/wifi-health-console/releases/download/v0.4.0/WiFi-Health-Console-Setup-arm64.exe">Windows ARM64 EXE</a>
  ·
  <a href="https://github.com/meyaomiao/wifi-health-console/releases/tag/v0.4.0">统一发布说明</a>
</p>
...
| 平台 | 当前版本 | 界面与采集 | 发布状态 |
| --- | --- | --- | --- |
| macOS | v0.4.0 | SwiftUI + CoreWLAN / macOS 系统网络能力 | 正式版，已签名与 Apple 公证 |
| Windows | v0.4.0 Preview | Avalonia + Windows Native WLAN API | 预览版，提供 x64 / ARM64 安装器 |
...
1. 普通 Intel / AMD Windows 电脑下载 [x64 EXE 安装器](https://github.com/meyaomiao/wifi-health-console/releases/download/v0.4.0/WiFi-Health-Console-Setup-x64.exe)；Windows on ARM 设备下载 [ARM64 EXE 安装器](https://github.com/meyaomiao/wifi-health-console/releases/download/v0.4.0/WiFi-Health-Console-Setup-arm64.exe)。
...
Windows Preview 如果尚未配置 Windows Authenticode 代码签名证书，SmartScreen 可能显示“Windows 已保护你的电脑”或“未知发布者”。请确认安装包来自本项目的官方 [v0.4.0 统一 Release](https://github.com/meyaomiao/wifi-health-console/releases/tag/v0.4.0)，并优先对照发布页中的 `SHA256SUMS.txt`。macOS 使用的 **Apple Developer ID Application** 证书只能签名 Apple 平台应用，不能用来签名 Windows `.exe`。
...
1. 下载 [Wi-Fi 体检台 v0.4.0 通用安装包](https://github.com/meyaomiao/wifi-health-console/releases/download/v0.4.0/Wi-Fi-Health-Console-0.4.0-universal.dmg)。也可以进入 [统一 Release 页面](https://github.com/meyaomiao/wifi-health-console/releases/tag/v0.4.0) 查看全部平台安装包。
2. 双击下载好的 `Wi-Fi-Health-Console-0.4.0-universal.dmg`。
...
```sh
shasum -a 256 ~/Downloads/Wi-Fi-Health-Console-0.4.0-universal.dmg
```

正确值请对照 [v0.4.0 Release 中的统一 SHA256SUMS.txt](https://github.com/meyaomiao/wifi-health-console/releases/download/v0.4.0/SHA256SUMS.txt)。该文件同时列出 macOS、Windows x64 和 Windows ARM64 三个安装包。
...
- 当前统一产品版本为 v0.4.0，同时提供 macOS 和 Windows Preview；尚未提供 Android 或 iPhone 版本。
